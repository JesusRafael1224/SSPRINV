...
function obtenerResultados(){
    try {
        ...
        /*Codigo SQL*/
        $res = "SELECT * FROM sistema;";
        
        $consulta = mysqli_query($db, $res);
                    ...
                    <table class="table mt-2">
                        ...
                        <tbody>
                            <?php foreach ($res as $val) { ?>
                              ...
                              <td> <a href='eliminar_prod.php?id=".$val[id]."'><button type='button' class='btn btn-danger'>Eliminar</button></a> </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
